...
- `scripts/write_table30v2_aloha_short_lerobot.py`：写出 64 帧 ALOHA 短 episode LeRobot repo，并运行 OpenPI dataloader smoke。
...
1. 将短 episode writer 扩展为可控分片 writer，支持按 task、robot、frame_count 输出本地 LeRobot repo。
