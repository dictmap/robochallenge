...
- `work.md`：exists=`True`，tracked=`True`，size=`93578`，sha256=`1873f3691ef6f94a9db21affde7f7604cc8bb448979acab1c19bfef8c65c1e04`。
- `notebooks/robochallenge_pi05_submit_cn.ipynb`：exists=`True`，tracked=`True`，size=`83476`，sha256=`62175cd96d42b91ec7806b217c532077d7295d0959bbb073d8964259508aa949`。
...
- `submission/AUTHORIZED_SUBMISSION_SEQUENCE.md`：exists=`True`，tracked=`True`，size=`4889`，sha256=`466af22eaa6fb28bcc91b600697483c24e72bb8df63b612075160dc804955f61`。
...
- `reports/checkpoint_archive_plan.md`：exists=`True`，tracked=`True`，size=`1412`，sha256=`2f0171b03fd8fb00e3c755038fae399cdaabdeaf6458cf4fb231cb4d381ef302`。
...
- `reports/checkpoint_archive_dry_run.md`：exists=`True`，tracked=`True`，size=`1581`，sha256=`ed9b244f99e359cba9f1eb8bb96902569434c9e9f5ae2d9a782b4ef7fed9fdc7`。
...
- `reports/notebook_structure_audit.md`：exists=`True`，tracked=`True`，size=`1367`，sha256=`8bfbd9695bb785e33da89923c6a66028cb18bdf58575a233ba41089a529d9de0`。
...
- `reports/authorized_execution_checklist.md`：exists=`True`，tracked=`True`，size=`4542`，sha256=`ee308b476faf1e846d582ab2a10a3551fb7dda454288b131e769447b1b8288b5`。
...
- `reports/submission_preflight_bundle.md`：exists=`True`，tracked=`True`，size=`2014`，sha256=`0b51a9434f2a993b1a88ebedcecc49c4b93204d1173574edffc1f7754b66bc9b`。
- `reports/plaintext_secret_scan.md`：exists=`True`，tracked=`True`，size=`610`，sha256=`5f0026f565e85081e44002da1fd0ae83b128b023b832af06d7f4638dd4c29324`。
- `reports/submission_status_dashboard.html`：exists=`True`，tracked=`True`，size=`10510`，sha256=`64b07d6f05bc7c1eca316ac272d217cca56a250088c76432e64debbbd4a51c43`。
- `scripts/audit_authorized_execution_checklist.py`：exists=`True`，tracked=`True`，size=`14237`，sha256=`00416ee640834409f1c87a7530a8e445a262a857dfeef5a0cfebce9afbe80a57`。
