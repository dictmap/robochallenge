...
- `work.md`：exists=`True`，tracked=`True`，size=`165377`，sha256=`74048d7486f32a31e1f0dda926ab60a2cf0c25346e04cab9179b797a876f94c0`。
...
- `reports/chinese_utf8_artifact_audit.md`：exists=`True`，tracked=`True`，size=`1045`，sha256=`31cc02b2120db78ff841961d65a15b2e62a540fec3262bd026cc0d17ec1cc0a8`。
...
- `reports/local_env_permission_contract.md`：exists=`True`，tracked=`False`，size=`1566`，sha256=`08bf60a84ff5ba2d5e0d1a5ea78df581d69a68830be6ab58ae56319ece1b2968`。
...
- `reports/submission_preflight_bundle.md`：exists=`True`，tracked=`True`，size=`6549`，sha256=`0e4f6245fc59f201765b1bc56ee2bfea992eadb527a89a221f0a0ab6645dcd78`。
- `reports/plaintext_secret_scan.md`：exists=`True`，tracked=`True`，size=`610`，sha256=`eace455197e3e4bff59ffba1808f3470b2bf73535a7b7db5b8fba37202871950`。
- `reports/submission_status_dashboard.html`：exists=`True`，tracked=`True`，size=`18981`，sha256=`0f9ca3e0734dbbeb19fc59f07f62d2673c372432ed67f8bf3ee0e9341c3f4c3b`。
...
- `scripts/audit_local_env_permission_contract.py`：exists=`True`，tracked=`False`，size=`8185`，sha256=`23641d0614747f2434def6a1220f8fad150dcec67bf763f3254527f7142ab4e4`。
