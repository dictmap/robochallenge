...
REQUIRED = [
    ...
    "runs/submission_target_confirmation_gate.json",
...
def main() -> int:
    ...
    if not all(
        [
            ...
            dashboard.get("web_form_field_count", 0) >= 13,
            ...
            dashboard.get("web_form_recommended_required_field_count", 0) >= 11,
            dashboard.get("web_form_recommended_ready_field_count", 0) >= 7,
            dashboard.get("web_form_recommended_missing_field_count", 0) == 4,
            ...
            "Submission Target Confirmation" in set(dashboard.get("web_form_recommended_route_blocking_names", [])),
            dashboard.get("web_form_target_confirmation_value") == "CONFIRM_TABLE30V2_ALOHA_BASELINE",
            dashboard.get("web_form_target_user_confirmed") is False,
            dashboard.get("web_form_target_confirmation_field_present") is True,
            dashboard.get("web_form_target_confirmation_required") is True,
            dashboard.get("web_form_target_confirmation_ready") is False,
            ...
            dashboard.get("submission_target_confirmation_gate_passed") is True,
            dashboard.get("submission_target_confirmation_gate_case_count") == 7,
            dashboard.get("submission_target_confirmation_gate_bad_rejected") is True,
            dashboard.get("submission_target_confirmation_gate_bad_stop_before_preflight") is True,
            dashboard.get("submission_target_confirmation_gate_correct_accepted") is True,
            dashboard.get("submission_target_confirmation_gate_real_runner_not_started") is True,
            dashboard.get("submission_target_confirmation_gate_no_contact") is True,
            dashboard.get("submission_target_confirmation_gate_no_leak") is True,
            ...
            dashboard.get("submission_variant_target_confirmation_value") == "CONFIRM_TABLE30V2_ALOHA_BASELINE",
            "SUBMISSION_TARGET_CONFIRMATION" in set(dashboard.get("submission_variant_baseline_blocking", [])),
            dashboard.get("submission_variant_route_count") == 2,
            dashboard.get("baseline_submission_quickstart_passed") is True,
            dashboard.get("baseline_submission_quickstart_target_confirmation_value")
            == "CONFIRM_TABLE30V2_ALOHA_BASELINE",
            dashboard.get("baseline_submission_quickstart_target_confirmation_manual_input") is True,
            ...
            dashboard.get("boolean_env_gate_passed") is True,
            dashboard.get("boolean_env_case_count") == 8,
            dashboard.get("boolean_env_bad_rejected") is True,
            dashboard.get("boolean_env_bad_stop_before_preflight") is True,
            dashboard.get("boolean_env_valid_accepted") is True,
            dashboard.get("boolean_env_real_runner_not_started") is True,
            dashboard.get("boolean_env_values_not_recorded") is True,
            dashboard.get("boolean_env_no_contact") is True,
            dashboard.get("boolean_env_no_leak") is True,
            ...
            dashboard.get("baseline_local_env_smoke_parent_real_confirm_scrubbed") is True,
            dashboard.get("baseline_local_env_smoke_confirmation_absent_after_scrub") is True,
            ...
            dashboard.get("baseline_final_handoff_rehearsal_parent_real_confirm_scrubbed") is True,
            dashboard.get("baseline_final_handoff_rehearsal_confirmation_absent_after_scrub") is True,
            ...
            dashboard.get("key_handoff_report_consistency_passed") is True,
            dashboard.get("key_handoff_report_consistency_checked_count") == 10,
            dashboard.get("key_handoff_report_consistency_mismatch_count") == 0,
            dashboard.get("key_handoff_report_consistency_missing_status_line_count") == 0,
            dashboard.get("key_handoff_report_consistency_bad_marker_hit_count") == 0,
            dashboard.get("key_handoff_report_consistency_secret_pattern_hit_count") == 0,
    ...
    if not all(
        [
            ...
            dashboard_gui.get("browser_visual_blocked_by_policy") is False,
            dashboard_gui.get("screenshot_created") is True,
            dashboard_gui.get("screenshot_path") == "reports/submission_status_dashboard_browser.png",
            (ROOT / dashboard_gui.get("screenshot_path", "")).exists(),
            dashboard_gui.get("screenshot_size_bytes", 0) > 10_000,
    ...
    if not all(
        [
            ...
            env_template.get("required_present", {}).get("ROBOCHALLENGE_SUBMISSION_TARGET_CONFIRMATION") is True,
            env_template.get("placeholder_values", {}).get("ROBOCHALLENGE_SUBMISSION_TARGET_CONFIRMATION") is True,
    ...
    if not all(
        [
            ...
            authorized_preflight.get("required_fragments", {}).get("requires_target_confirmation") is True,
            ...
            authorized_preflight_smoke.get("target_confirmation_present") is True,
    ...
    if not all(
        [
            ...
            ready_real_runner.get("required_fragments", {}).get("requires_target_confirmation") is True,
            ready_real_runner.get("required_fragments", {}).get("target_confirmation_phrase") is True,
            ...
            ready_real_no_credentials.get("target_confirmation_present") is True,
            ...
            ready_real_no_confirm.get("target_confirmation_present") is True,
            ...
            ready_real_wrong_confirm.get("target_confirmation_present") is True,
            ...
            all(item.get("target_confirmation_present") is True for item in ready_real_malformed_confirm_cases),
    ...
    if not all(
        [
            ...
            web_form_packet.get("field_count", 0) >= 13,
            web_form_packet.get("ready_field_count", 0) >= 7,
            web_form_packet.get("missing_field_count", 0) >= 6,
            web_form_packet.get("recommended_route") == "baseline_official_aloha",
            web_form_packet.get("recommended_route_ready") is False,
            web_form_packet.get("recommended_route_required_field_count") == 11,
            web_form_packet.get("recommended_route_ready_field_count") == 7,
            web_form_packet.get("recommended_route_missing_field_count") == 4,
            ...
            "Submission Target Confirmation" in web_form_route_blocking_names,
            web_form_packet.get("target_confirmation_value") == "CONFIRM_TABLE30V2_ALOHA_BASELINE",
            web_form_packet.get("target_user_confirmed") is False,
            web_form_packet.get("target_confirmation_field_present") is True,
            web_form_packet.get("target_confirmation_field_required_for_recommended_route") is True,
            web_form_packet.get("target_confirmation_field_ready_for_recommended_route") is False,
    ...
    if not all(
        ...
        print("提交对象确认包审计未通过")
        return 1
    target_gate = json.loads((ROOT / "runs/submission_target_confirmation_gate.json").read_text(encoding="utf-8"))
    target_gate_evidence = target_gate.get("evidence", {})
    target_gate_leaks = target_gate.get("leak_flags", {})
    target_gate_contacts = target_gate.get("contact_flags", {})
    target_gate_cases = target_gate.get("cases", [])
    bad_target_gate_cases = [item for item in target_gate_cases if item.get("expected_returncode") == 69]
    good_target_gate_cases = [item for item in target_gate_cases if item.get("expected_returncode") != 69]
    if not all(
        [
            target_gate.get("kind") == "submission_target_confirmation_gate",
            target_gate.get("passed"),
            target_gate.get("confirmation_env_key") == "ROBOCHALLENGE_SUBMISSION_TARGET_CONFIRMATION",
            target_gate.get("confirmation_value") == "CONFIRM_TABLE30V2_ALOHA_BASELINE",
            target_gate.get("recommended_route") == "baseline_official_aloha",
            target_gate.get("case_count") == 7,
            target_gate.get("bad_case_count") == 5,
            target_gate.get("good_case_count") == 2,
            len(target_gate_cases) == 7,
            len(bad_target_gate_cases) == 5,
            len(good_target_gate_cases) == 2,
            target_gate.get("real_runner_started") is False,
            target_gate.get("synthetic_values_recorded") is False,
            target_gate_evidence.get("bad_confirmations_rejected") is True,
            target_gate_evidence.get("bad_confirmations_stop_before_preflight") is True,
            target_gate_evidence.get("correct_confirmation_accepted") is True,
            target_gate_evidence.get("authorized_correct_reaches_dry_run") is True,
            target_gate_evidence.get("ready_correct_stops_without_real_confirm") is True,
            target_gate_evidence.get("all_cases_expected_returncodes") is True,
            target_gate_evidence.get("all_cases_no_protected_values") is True,
            target_gate_evidence.get("real_runner_not_started") is True,
            target_gate_evidence.get("restore_clean_state_passed") is True,
            all(item.get("target_rejected") is True for item in bad_target_gate_cases),
            all(item.get("preflight_started") is False for item in bad_target_gate_cases),
            all(item.get("correct_accepted") is True for item in good_target_gate_cases),
            all(item.get("printed_protected_values") is False for item in target_gate_cases),
            all(item.get("real_runner_started") is False for item in target_gate_cases),
            not any(target_gate_leaks.values()),
            not any(target_gate_contacts.values()),
            target_gate.get("platform_contacted") is False,
            target_gate.get("uploads_performed") is False,
            target_gate.get("credentials_read") is False,
            target_gate.get("credentials_printed") is False,
            target_gate.get("link_values_printed") is False,
            target_gate.get("secret_values_printed") is False,
        ]
    ):
        print("提交对象确认运行时 gate 审计未通过")
        return 1
    ...
    if not all(
        [
            ...
            baseline_quickstart.get("target_confirmation_value") == "CONFIRM_TABLE30V2_ALOHA_BASELINE",
            baseline_quickstart.get("target_confirmation_manual_input_required") is True,
            baseline_quickstart.get("target_confirmation_exact_match_required") is True,
            ...
            any("CONFIRM_TABLE30V2_ALOHA_BASELINE" in item.get("command", "") for item in quickstart_commands),
    ...
    if not all(
        ...
        return 1
    boolean_env_gate = json.loads((ROOT / "runs/boolean_env_gate.json").read_text(encoding="utf-8"))
    boolean_env_evidence = boolean_env_gate.get("evidence", {})
    boolean_env_leaks = boolean_env_gate.get("leak_flags", {})
    boolean_env_contacts = boolean_env_gate.get("contact_flags", {})
    boolean_env_cases = {item.get("name"): item for item in boolean_env_gate.get("cases", [])}
    bad_boolean_cases = [
        item
        for item in boolean_env_cases.values()
        if item.get("name")
        in {
    ...
    good_boolean_cases = [
        ...
        if item.get("name")
        in {
            "authorized_flags_zero",
            "authorized_require_ready_one",
            "ready_baseline_verify_zero",
            "ready_lora_verify_zero",
        }
    ]
    if not all(
        [
            boolean_env_gate.get("kind") == "boolean_env_gate",
            boolean_env_gate.get("passed"),
            boolean_env_gate.get("recommended_route") == "baseline_official_aloha",
            boolean_env_gate.get("case_count") == 8,
            boolean_env_gate.get("bad_case_count") == 4,
            boolean_env_gate.get("good_case_count") == 4,
            len(boolean_env_cases) == 8,
            len(bad_boolean_cases) == 4,
            len(good_boolean_cases) == 4,
            boolean_env_gate.get("bad_flags_rejected") is True,
            boolean_env_gate.get("bad_flags_stop_before_preflight") is True,
            boolean_env_gate.get("valid_flags_accepted") is True,
            boolean_env_gate.get("real_runner_started") is False,
            boolean_env_gate.get("synthetic_values_recorded") is False,
            all(item.get("returncode") == 68 for item in bad_boolean_cases),
            all(item.get("bool_rejected") is True for item in bad_boolean_cases),
            all(item.get("preflight_started") is False for item in bad_boolean_cases),
            all(item.get("printed_protected_values") is False for item in bad_boolean_cases),
            all(item.get("valid_flags_accepted") is True for item in good_boolean_cases),
            all(item.get("preflight_started") is True for item in good_boolean_cases),
            all(item.get("real_runner_started") is False for item in boolean_env_cases.values()),
            all(boolean_env_evidence.values()),
            boolean_env_gate.get("clean_state_restore", {}).get("passed") is True,
            not any(boolean_env_leaks.values()),
            not any(boolean_env_contacts.values()),
            boolean_env_gate.get("platform_contacted") is False,
            boolean_env_gate.get("uploads_performed") is False,
            boolean_env_gate.get("credentials_read") is False,
            boolean_env_gate.get("credentials_printed") is False,
            boolean_env_gate.get("link_values_printed") is False,
            boolean_env_gate.get("secret_values_printed") is False,
        ]
    ):
        print("布尔环境变量 gate 审计未通过")
        return 1
    ...
    if not all(
        [
            ...
            baseline_local_env_smoke.get("parent_real_confirm_phrase_injected") is True,
            baseline_local_env_smoke.get("parent_real_confirm_phrase_value_recorded") is False,
            ...
            local_env_authorized.get("target_confirmation_present") is True,
            ...
            local_env_ready.get("target_confirmation_present") is True,
            local_env_ready.get("dry_run_called") is True,
            local_env_ready.get("parent_real_confirm_injected_before_scrub") is True,
            local_env_ready.get("parent_real_confirm_present_in_subprocess_env") is False,
            local_env_ready.get("confirmation_absent") is True,
    ...
    if not all(
        [
            ...
            baseline_final_handoff_rehearsal.get("parent_real_confirm_phrase_injected") is True,
            baseline_final_handoff_rehearsal.get("parent_real_confirm_phrase_value_recorded") is False,
            ...
            rehearsal_step2.get("target_confirmation_present") is True,
            ...
            rehearsal_step3.get("target_confirmation_present") is True,
            rehearsal_step3.get("dry_run_called") is True,
            rehearsal_step3.get("parent_real_confirm_injected_before_scrub") is True,
            rehearsal_step3.get("parent_real_confirm_present_in_subprocess_env") is False,
            rehearsal_step3.get("confirmation_absent") is True,
    ...
    if not all(
        [
            ...
            preflight.get("web_form_recommended_route_required_field_count") == 11,
            preflight.get("web_form_recommended_route_ready_field_count") == 7,
            preflight.get("web_form_recommended_route_missing_field_count") == 4,
            ...
            "Submission Target Confirmation"
            in set(preflight.get("web_form_recommended_route_blocking_names", [])),
            preflight.get("web_form_target_confirmation_value") == "CONFIRM_TABLE30V2_ALOHA_BASELINE",
            preflight.get("web_form_target_user_confirmed") is False,
            preflight.get("web_form_target_confirmation_field_present") is True,
            preflight.get("web_form_target_confirmation_required") is True,
            preflight.get("web_form_target_confirmation_ready") is False,
            ...
            preflight.get("submission_target_confirmation_gate_passed") is True,
            preflight.get("submission_target_confirmation_gate_case_count") == 7,
            preflight.get("submission_target_confirmation_gate_bad_rejected") is True,
            ...
            preflight.get("baseline_submission_quickstart_passed") is True,
            preflight.get("baseline_submission_quickstart_target_confirmation_value")
            == "CONFIRM_TABLE30V2_ALOHA_BASELINE",
            ...
            preflight.get("boolean_env_gate_passed") is True,
            preflight.get("boolean_env_bad_rejected") is True,
            preflight.get("boolean_env_bad_stop_before_preflight") is True,
            preflight.get("boolean_env_valid_accepted") is True,
            preflight.get("boolean_env_real_runner_not_started") is True,
            preflight.get("boolean_env_values_not_recorded") is True,
            ...
            preflight.get("baseline_local_env_smoke_parent_real_confirm_scrubbed") is True,
            preflight.get("baseline_local_env_smoke_confirmation_absent_after_scrub") is True,
            ...
            preflight.get("baseline_final_handoff_rehearsal_parent_real_confirm_scrubbed") is True,
            preflight.get("baseline_final_handoff_rehearsal_confirmation_absent_after_scrub") is True,
